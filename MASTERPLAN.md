...
- ⚠️ **Bekannte Lücke:** Der echte Fireworks-Modellname für `gemma-4-26b-a4b-it` (ohne `accounts/fireworks/models/`-Prefix o. Ä.) ist nur eine Vermutung aus dem Discord — lokale Tests mit echter Eskalation schlagen aktuell mit 404 fehl. Die exakten IDs kommen laut PDF erst "on launch day" vom Harness selbst; für die Submission kein Problem (Harness injiziert den echten Wert), aber lokal ist Eskalation vorerst ungetestet.
